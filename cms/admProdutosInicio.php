        ...
        <div id="caixa_adm_usuario">
                ...
                <a href="admCategoria.php">
                    <div class="item_menu_adm1">
                        <img src="image/cat.png" width="120" heigth="120"></a>
                    </div>
                    <div class="item_menu_adm1">
                    <a href="admSubCategoria.php">
                        <img src="image/sub.png" width="120" heigth="120">
                    </a>
                    </div>
                    <div class="item_menu_adm1">
                    <a href="admProdutos.php">
                        <img src="image/agenda.png" width="120" heigth="120">
                    </a>
                    </div>
                </div>
            </div>
